...
\begin{align}
    ...
    {\sum_n \frac{\pi}{\sqrt{|\Delta|^2 + \epsilon_n^2}}}
\end{align}
We can only sum over the positive Matsubara frequencies and take real part because
if we substitute Eq. (\ref{symmetry_relation}) into Eq. (\ref{f_decomp}), we get
\begin{align}
...
\end{align}
and we can also only average the angular part over a half circle, because
\begin{align}
