...
\end{align}
In bulk we have $\hat{\Delta}(\vb{r}, \vb{p}) = \hat{\sigma}_x \Delta(p_x + ip_y)$.
The interaction is $v(\vb{p}, \vb{p}') = 3v_0\vu{p}\vdot\vu{p}'$, and the
gap-equation reduces to
\begin{align}
    \ln{\frac{T}{T_c}} = T\sum_{\epsilon_n=-\infty}^{\infty}
    \left[
        \frac{2\ev{\vb{p}\vdot\vb{p}'f(\vb{r}, \vb{p}', \epsilon_n)}_{p'}}
        {\Delta(\vb{r}, \vb{p})}
        - \frac{\pi}{|\epsilon_n|}
        \right]
\end{align}
...
\begin{align}
    \ln{\frac{T}{T_c}} = T\sum_{\epsilon_n=-\infty}^{\infty}
    \left[
        \frac{\ev{f(\vb{r}, \vb{p}', \epsilon_n)}_{p'}}
        {\Delta(\vb{r}, \vb{p})}
        - \frac{\pi}{|\epsilon_n|}
        \right]
\end{align}
...
\begin{align}
    \ln{\frac{T}{T_c}} = T\sum_{\epsilon_n=-\infty}^{\infty}
    \left[
    \frac{\ev{\vb{p}_{x,y}\vdot\vb{p}'f_{1,2}(x, \vb{p}', \epsilon_n)}_{p'}}
    {\Delta_{1,2}(x)}
    - \frac{\pi}{|\epsilon_n|}
    \right]
\end{align}
