...
\end{align}
Analytically continue to real frequency, we get
\begin{align}
    \vb{j}(\vb{R})=2N_f\int\dd\epsilon f(\epsilon)
...
For Matsubara frequency, we replace $e \rightarrow i(2n+1)\pi t/\delta(T)$.
