...
\begin{align}
    \vb{j}_m(\vb{R}) \equiv m^*\vb{j}(\vb{R}) = \frac{2N_fv_fp_f}{4}\hbar \times \frac{4T}{\xi(T)|\Delta(T)|}\sum_n\ev{\vu{p} g(\vb{R}, \vb{p}, \epsilon_n)}_{p}
\end{align}
where $\xi(T) = \hbar v_f/|\Delta(T)|$ is the coherence length, and $n = 2N_fp_fv_f$ is the particle density.
...
\begin{align}
    \vb{L} & = \int_0^R \dd[3]r \vb{r} \times \vb{j}_m(\vb{r})                                                                                      \\
           ...
           & = \frac{N}{2}\hbar \vu{z} \times \frac{4T}{\xi(T)|\Delta(T)|}\int_{R-\xi}^R \dd{r} \sum_n\ev{\vu{p} g(\vb{r}, \vb{p}, \epsilon_n)}_{p}
\end{align}
...
\begin{align}
    ip_x\partial_x a(\vb{p},x) + 2\frac{ie_n}{\delta(t)}a(\vb{p},x) + a(\vb{p},x)\delta^*(\vb{p},x) a(\vb{p},x) + \delta(\vb{p},x) = 0 \\
    ip_x\partial_x \underline{a}(\vb{p},x) - 2\frac{ie_n}{\delta(t)} \underline{a}(\vb{p},x) - \underline{a}(\vb{p},x)\delta(\vb{p},x)\underline{a}(\vb{p},x) - \delta^*(\vb{p},x) = 0
\end{align}
where $\xi = \hbar v_f/|\Delta(T)|$ and $\va{\partial} = \xi\grad$.
