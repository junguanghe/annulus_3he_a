...
\begin{align}
    ...
    = -i\pi\widehat{N}
    \begin{pmatrix}
        1+\hat{a}\hat{\underbar{a}} & 2\hat{a}                     \\
        -2\hat{\underbar{a}}        & -1-\hat{\underbar{a}}\hat{a}
    \end{pmatrix}
\end{align}
where $\widehat{N}$ is
\begin{align}
    \widehat{N} =
    \begin{pmatrix}
        (1-\hat{a}\hat{\underbar{a}})^{-1} & 0                                  \\
        0                                  & (1-\hat{\underbar{a}}\hat{a})^{-1}
    \end{pmatrix}
\end{align}
...
\begin{align}
    ...
    i\hbar\vb{v}_p \vdot \grad{\hat{\underbar{a}}} - 2\epsilon\hat{\underbar{a}}
    - \hat{\underbar{a}}\hat{\Delta}\hat{\underbar{a}} - \hat{\Delta}^\dagger = 0
\end{align}
