...
the temperature dependence of the angular momentum is described by the
...
\end{align}
here we define the `critical angular momentum density'
$l_c = j_c\xi$, where $j_c = |f_\text{min}|/v_c$, $v_c = \hbar/M\xi$,
